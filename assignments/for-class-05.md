...
The first four assignments build a multi-notebook MyST document. Complete them in order — the MyST Assembly step weaves everything together and produces the PR.
