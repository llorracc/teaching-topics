# Assignment: LitMaps — Subsequent Citations Bibliography
...
Create a BibTeX file containing papers that have **cited** your ballpark paper (subsequent literature), using LitMaps.

This bibliography will later be used to add a "Subsequent Literature" section to your ballpark entry.
...
2. If it doesn't appear in search, it may be in your imported articles — check "My Articles"

---

### 4. Create a new LitMap focused on citing papers
...
**Save this file** — you will use it in class to add a "Subsequent Literature" section to your ballpark entry.
...
- Try broadening your search to related papers
- If truly no citations exist, document this and we'll discuss alternatives in class

**"Too many citing papers (>100)":**
- This is a good problem! Be selective
- Focus on the most recent and most cited
- Consider creating a second map if needed (you have 2 maps on free accounts)
