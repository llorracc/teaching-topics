...
Due before Class 11: see **[Assignments for Class 11](https://github.com/llorracc/teaching-topics/blob/main/assignments/for-class-11.md)** — **Anthropic key / billing** (#131), **named Matsya session** (#132), then **ballpark / Dolo Plus draft** (#130). Run roster: [`teaching-topics/run.md`](https://github.com/llorracc/teaching-topics/blob/main/run.md).
